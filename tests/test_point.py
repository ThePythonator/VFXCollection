...
def test_point_custom_values_float():
    point = Point.Point2D(8.57, 27.25)
    assert point.x == 8.57 and point.y == 27.25
    
def test_point_point_addition():
    point = Point.Point2D(8, 27) + Point.Point2D(9, 4)
...
def test_point_point_truedivision():
    point = Point.Point2D(8, 27) / Point.Point2D(4, 9)
    assert point.x == 2 and point.y == 3
    
def test_point_point_floordivision():
    point = Point.Point2D(8, 27) // Point.Point2D(3, 4)
...
def test_point_comparison_equals():
    point = Point.Point2D(4, -5)
    assert not (point != Point.Point2D(4, -5))

def test_point_comparison_not_equals():
    point = Point.Point2D(4, -5)
    assert point == Point.Point2D(4, -5)